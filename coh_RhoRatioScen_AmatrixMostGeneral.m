function coh = coh_RhoRatioScen_AmatrixMostGeneral(SmallC,D,x)
    ...
    coh = cal_coh_MainFunc(SmallC,D,T,L1_flat0,R1_flat0,L_SigmaPlus,L_SigmaMinus,R_SigmaPlus,R_SigmaMinus);
